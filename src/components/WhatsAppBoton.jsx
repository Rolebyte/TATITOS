...
export default function WhatsAppBoton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-40 w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200"
